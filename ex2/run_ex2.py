...
def fracwTime(tn):
    return (4.5*math.gamma(4.5)/math.gamma(5)*tn**4)

def dwTime(tn):
    return (4.5*3.5*tn**2.5)
...
for i in range(iMin,iMax):
    ...
    for j in range(jMin,jMax): 
        ...
        P = (1.0/dt)*M+dt/4.0*A+0.5*sqrt(dt)/c_frac*A+(1.0/dt)*J
        ...
        for nt in range(0,Nt):
            ...
            f.utn=utn; f.dwtn=dwtn; f.fwtn=fwtn;
...
if m>2:    
    ...
    %(d1,d2,d3,d4))   
    if k==1:        
        np.savetxt("L2_error_linear_velo_ex2.txt",l2wDiag,fmt="%2.3e")
        np.savetxt("L2_error_linear_disp_ex2.txt",l2uDiag,fmt="%2.3e")
        np.savetxt("H1_error_linear_velo_ex2.txt",h1wDiag,fmt="%2.3e")
        np.savetxt("H1_error_linear_disp_ex2.txt",h1uDiag,fmt="%2.3e")
        
    elif k==2:
        np.savetxt("L2_error_quad_velo_ex2.txt",l2wDiag,fmt="%2.3e")
        np.savetxt("L2_error_quad_disp_ex2.txt",l2uDiag,fmt="%2.3e")
        np.savetxt("H1_error_quad_velo_ex2.txt",h1wDiag,fmt="%2.3e")
        np.savetxt("H1_error_quad_disp_ex2.txt",h1uDiag,fmt="%2.3e") 
